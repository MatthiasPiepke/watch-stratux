            ...
            while (TCPisRunning) {
                if( wifiManager.isWifiEnabled() == true ){
                    ...
                    if( AppData.connectionAlarmIsSet == false ) {
                        if( AppData.vibration_alarm.value == true ) AppData.vibrator.vibrate(VibrationEffect.createWaveform(AppData.alarmConnectionPattern, AppData.alarmConnectionTiming, -1))
