...
class IpPortActivity : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var portPosition = 0
        var portString = AppData.preferences.ipPort.value.toString().padStart(5, '0')
        var portText = ""
        ...
        okayButton.setOnClickListener {
            AppData.preferences.ipPort.value = portString.toInt()
            AppData.preferenceHandler.savePreference(AppData.preferences.ipPort)
